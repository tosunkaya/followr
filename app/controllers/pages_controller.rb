class PagesController < ApplicationController
	...
	def dashboard
		...
		@began_following_users = current_user.twitter_follow.first.created_at.to_date.strftime('%m/%d/%y') if @followed_users_count > 0
		@followers = current_user.followers.last.count
	end
end
